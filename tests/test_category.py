...
def test_category3(category3, grass1, grass2):
    assert category3.name == "Газонная трава"
    assert category3.description == "Различные виды газонной травы"
...
def test_category4(category4, smartphone1, smartphone2, smartphone3):
    assert category4.name == "Смартфоны"
    assert category4.description == "Высокотехнологичные смартфоны"
    assert category4.products == (
